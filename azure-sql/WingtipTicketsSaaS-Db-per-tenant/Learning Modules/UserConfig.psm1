...
$ResourceGroupName = "sql-perfmonitoring-rg" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "cneal"         # the User value entered when the Wingtip SaaS application was deployed
